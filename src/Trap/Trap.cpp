...
{ 
	...
	{																		   //3番目は横画像
		trap[0].trapPosX = 448, trap[1].trapPosX = 576, trap[2].trapPosX = 768, trap[3].trapPosX = 1024, trap[4].trapPosX = 448, trap[5].trapPosX = 608, trap[6].trapPosX = 768, trap[7].trapPosX = 960, trap[8].trapPosX = 1279, trap[9].trapPosX = 1311, trap[10].trapPosX =1343, trap[11].trapPosX = 1375, trap[12].trapPosX = 2112, trap[13].trapPosX = 2144, trap[14].trapPosX= 2172;
		trap[0].trapPosY = 608, trap[1].trapPosY = 608, trap[2].trapPosY = 608, trap[3].trapPosY = 640, trap[4].trapPosY = 384, trap[5].trapPosY = 384, trap[6].trapPosY = 384, trap[7].trapPosY = 384, trap[8].trapPosY = 896, trap[9].trapPosY = 896, trap[10].trapPosY = 896, trap[11].trapPosY = 896, trap[12].trapPosY = 642, trap[13].trapPosY = 642, trap[14].trapPosY= 642;
